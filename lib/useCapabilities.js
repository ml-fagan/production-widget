...
const EVERYTHING = {
  ...
  handover: true,
  manage: true,
  tabs: ["schedule", "board", "materials", "warehouse", "stock", "materiallist", "allocation", "invoicing", "requests", "handover"],
};

const NOTHING = { ...EVERYTHING, processSteps: false, schedule: false, receiving: false, allocation: false, materials: false, invoicing: false, handover: false, manage: false };

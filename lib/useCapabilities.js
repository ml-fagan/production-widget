...
const EVERYTHING = {
  ...
  handover: true,
  manage: true,
  tabs: ["schedule", "board", "materials", "stock", "invoicing", "handover"],
};

const NOTHING = { ...EVERYTHING, processSteps: false, schedule: false, materials: false, invoicing: false, handover: false, manage: false };
